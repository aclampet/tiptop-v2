-- ============================================================
-- log_verification_event RPC (SECURITY DEFINER)
-- ============================================================
...
GRANT EXECUTE ON FUNCTION public.log_verification_event(UUID, UUID, TEXT, JSONB, TEXT) TO authenticated;
GRANT EXECUTE ON FUNCTION public.log_verification_event(UUID, UUID, TEXT, JSONB, TEXT) TO anon;
